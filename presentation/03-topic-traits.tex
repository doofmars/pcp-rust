...
\begin{frame}[fragile,t]{Trait Generics}
    Trait definition:
    \mylisting{2}{4}{Rust}{Trait mit Generics}{../rust/example-traits-associated-types/src/main.rs}

    \pause
    Trait implementation:
    \mylisting{7}{11}{Rust}{Trait mit Generics}{../rust/example-traits-associated-types/src/main.rs}
\end{frame}

\begin{frame}[fragile,t]{Trait Assiozierten Typen}
    Trait definition:
    \mylisting{14}{18}{Rust}{Trait mit Assiozierten Typen}{../rust/example-traits-associated-types/src/main.rs}

    \pause
    Trait implementation:
    \mylisting{21}{27}{Rust}{Trait mit Assiozierten Typen}{../rust/example-traits-associated-types/src/main.rs}
\end{frame}
