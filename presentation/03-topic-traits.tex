...
\begin{frame}[fragile,t]{Trait Generics}
    Trait definition:
    \mylistingHiglight{2}{4}{Rust}{Rust}{Trait mit Generics}{}{../rust/example-traits-associated-types/src/main.rs}

    \pause
    Trait implementation:
    \mylistingHiglight{6}{10}{Rust}{Rust}{Trait mit Generics}{}{../rust/example-traits-associated-types/src/main.rs}
\end{frame}

\begin{frame}[fragile,t]{Trait Assiozierten Typen}
    Trait definition:
    \mylistingHiglight{13}{17}{Rust}{Rust}{Trait mit Assiozierten Typen}{}{../rust/example-traits-associated-types/src/main.rs}

    \pause
    Trait implementation:
    \mylistingHiglight{19}{25}{Rust}{Rust}{Trait mit Assiozierten Typen}{}{../rust/example-traits-associated-types/src/main.rs}
\end{frame}
